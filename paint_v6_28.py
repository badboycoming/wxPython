...
# -*- coding:utf-8 -*-
#-----------------------------------------------------------------------------
# Purpose: paint version 6, add ColourDialog.
#-----------------------------------------------------------------------------
...
class Frame(wx.Frame):
    ...
    def __init__(self, parent=None, id=-1):
        self.title = 'Paint'
        super(self.__class__, self).__init__(parent=parent, id=-1, title=self.title, size=(800, 600))
        self.filename = ''
                ...
                (
                    ...
                    ('&Color',
                        (
                            ...
                            # ('&Other...', '', self.OnOtherColor, wx.ITEM_RADIO),  # if set to ITEM_RADIO, only can chose once...
    ...
    def OnOtherColor(self, event):
        dlg = wx.ColourDialog(parent=self)
